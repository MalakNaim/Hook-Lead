    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="mb-4 flex items-center justify-between">
          ...
          <Link href="/leads" className="text-sm font-medium text-gray-400 hover:text-gray-700 transition-colors">
              ...
              {scoredLeads.map((lead) => (
                <tr key={lead.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3">
                    <Link href={`/leads/${lead.id}`} className="font-medium text-gray-900 hover:text-gray-700">
